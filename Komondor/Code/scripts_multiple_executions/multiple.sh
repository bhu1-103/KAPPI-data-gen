...
do 
	...
	./komondor_main ../input/test_sce4/${array[executing_ix]} /home/pokeymystery/Komondor/Code/input/agents2.csv ../outputs/test_sce4_output.txt sim_${array[executing_ix]} 0 0 0 1 1 $SIM_TIME $SEED >> ../output/logs_console.txt 
