...
do 
	...
	./komondor_main ../input/script_input_files/nodes/${array[executing_ix]} ../input/script_input_files/agents/agents.csv ../output/script_output.txt sim_${array[executing_ix]} 0 0 0 1 1 1 $SIM_TIME $SEED
