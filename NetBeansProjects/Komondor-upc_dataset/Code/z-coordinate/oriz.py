...
count=0
path = r"/home/bhu2/NetBeansProjects/Komondor-upc_dataset/Code/output/"
# read all the files with extension .csv
f1 = glob.glob(path + "/*.csv")

path3 =r"/home/bhu2/NetBeansProjects/Komondor-upc_dataset/Code/z-coordinate/op-z-coordinate"
#print('File names:' , f1)
