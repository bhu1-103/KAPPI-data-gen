...
//                System.out.println("   + STA: " + bss.stas_position_list[n]);
    ...
    public static void main(String args[]) throws IOException {
        ...
        String input_path = "/home/bhu2/NetBeansProjects/Komondor-upc_dataset/Code/copy.csv";
        System.out.println("input_path: " + input_path);
        String output_path = "/home/bhu2/NetBeansProjects/Komondor-upc_dataset/Code/output/*";
        ...
        for (int i = 0; i < num_bss; ++i) {
            ...
            x = rand.nextDouble() * map_width;
            y = rand.nextDouble() * map_height;
        ...
        for (int i = 0; i < num_random_deployments; ++i) {   
            ...
            output_path = "/home/bhu2/NetBeansProjects/Komondor-upc_dataset/Code/output/input_nodes_copy_deployment_" + String.format("%03d", i) + ".csv";
